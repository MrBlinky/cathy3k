...
call :make arduboymini-bootloader-ds3231-menu "-DARDUBOYMINI -DDS3231 -DSUPPORT_POWERDOWN -DDEVICE_VID=0x2341 -DDEVICE_PID=0x0036"
call :make arduboymini-bootloader-ds3231-game "-DARDUBOYMINI -DDS3231 -DSUPPORT_POWERDOWN -DRUN_APP_ON_POWERON -DDEVICE_VID=0x2341 -DDEVICE_PID=0x0036"

call :make arduboymini-bootloader-rv3028-menu "-DARDUBOYMINI -DRV3028 -DSUPPORT_POWERDOWN -DDEVICE_VID=0x2341 -DDEVICE_PID=0x0036"
call :make arduboymini-bootloader-rv3028-game "-DARDUBOYMINI -DRV3028 -DSUPPORT_POWERDOWN -DRUN_APP_ON_POWERON -DDEVICE_VID=0x2341 -DDEVICE_PID=0x0036"
